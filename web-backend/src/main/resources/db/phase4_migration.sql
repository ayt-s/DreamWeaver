...
ALTER TABLE creative_task ADD COLUMN gen_type VARCHAR(32) DEFAULT 'text_video' COMMENT '生成类型：text_video(纯文本视频)/image_video(图生视频)/text_image(文生图)' AFTER status;
